...
export default function TitleandSearch({ onSearch }) {
    ...
    return (
        <div className="bg-white rounded-lg shadow-md p-8 mb-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <button className="bg-green-600 text-white px-6 py-3 rounded-lg hover:bg-green-700 transition-colors shadow-md whitespace-nowrap">
                    Add New Title
                </button>
            </div>
        </div>
